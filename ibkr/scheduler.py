            ...
            try:
                ...
                if phase == "weekend":
                    ...
                    if await self._setup_tables_if_needed():
                        ...
                        self.logger.error("X Pre-market checks failed - QuestDB/tables not ready")
                        tables_ready = False
                        print("⚠ ALERT: IBKR pre-market checks failed! Please fix QuestDB/tables before market opens.")
